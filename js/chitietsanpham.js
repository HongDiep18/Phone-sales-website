...
function phanTich_URL_chiTietSanPham() {
    ...
    var moTa = document.getElementById('productDescription');
    if (moTa) {
        moTa.textContent = sanPhamHienTai.description || '';
        moTa.style.display = sanPhamHienTai.description ? 'block' : 'none';
    }
    ...
    // Hình nhỏ (dùng ảnh chính của sản phẩm)
    var banner = document.getElementsByClassName('owl-carousel')[0];
    banner.innerHTML = '';
    var anhChinh = sanPhamHienTai.img;
    addSmallImg(anhChinh);
    addSmallImg(anhChinh);
    addSmallImg(anhChinh);
